...
void runMacro_mass(bool local=true, bool full=true, bool gridMerge=true){
  ...
  char* output_dir = "pid_cuts_hf_vertex";
  ...
  AliAnalysisTaskD0Mass *task = reinterpret_cast<AliAnalysisTaskD0Mass*>(gInterpreter->ExecuteMacro("AddD0MassTask.C"));
  ...
  if(local) {
    ...
    alienHandler->SetAdditionalLibs("AliAnalysisTaskD0Mass.cxx AliAnalysisTaskD0Mass.h");
    alienHandler->SetAnalysisSource("AliAnalysisTaskD0Mass.cxx");
    ...
    alienHandler->SetExecutable("D0Mass.sh");
    alienHandler->SetJDLName("D0Mass.jdl");
