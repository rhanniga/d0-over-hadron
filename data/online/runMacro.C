...
void runMacro(bool local=true, bool full=true, bool gridMerge=true){
  ...
  char* work_dir = "D0_hadron_ratio";
  char* output_dir = "cent_0_20_firstRun";
  ...
  gInterpreter->LoadMacro("AliAnalysisTaskD0HadronRatio.cxx++g");
  AliAnalysisTaskD0HadronRatio *task = reinterpret_cast<AliAnalysisTaskD0HadronRatio*>(gInterpreter->ExecuteMacro("AddD0HadronRatioTask.C"));
  ...
  if(local) {
    ...
    alienHandler->SetAdditionalLibs("AliAnalysisTaskD0HadronRatio.cxx AliAnalysisTaskD0HadronRatio.h");
    alienHandler->SetAnalysisSource("AliAnalysisTaskD0HadronRatio.cxx");
    ...
    alienHandler->SetExecutable("D0HadronRatio.sh");
    alienHandler->SetJDLName("D0HadronRatio.jdl");
